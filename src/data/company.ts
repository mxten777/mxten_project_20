...
export const companyInfo: CompanyInfo = {
  name: '바이브코딩 (VibeCoding)',
  tagline: 'Innovative MVP Solutions for Digital Transformation',
  description: '바이브코딩은 혁신적인 MVP(Minimum Viable Product) 개발로 기업의 디지털 전환을 가속화하는 전문 개발팀입니다. 28개의 성공적인 MVP 프로젝트를 통해 다양한 산업군의 디지털 혁신을 이끌어왔습니다.',
